...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { changelog: @version.changelog, number: @version.number, program_id: @version.program_id } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { changelog: @version.changelog, number: @version.number, program_id: @version.program_id } }
