...
class ProgramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create program" do
    assert_difference('Program.count') do
      post programs_url, params: { program: { description: @program.description, name: @program.name } }
    end
  ...
  test "should update program" do
    patch program_url(@program), params: { program: { description: @program.description, name: @program.name } }
